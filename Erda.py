...
poll = LinePoll(cl)
call = cl
creator = ["u249b2e9b85320a4259ae5769ad5e018a"]
owner = ["u249b2e9b85320a4259ae5769ad5e018a"]
admin = ["u249b2e9b85320a4259ae5769ad5e018a"]
staff = ["u249b2e9b85320a4259ae5769ad5e018a"]
...
wait = {
    ...
    "unsend":False,
    "mention":"⌬ INSAF ehh.... \n⌬ Sini di ruqiyah 😁😁  \n⌬ Biar ga ngintip mulu 😂😂  ",
    "Respontag":"⌬ Tag terus sampai gempor  😂😂   ",
    "welcome":"⌬ Welcome... \n⌬ Jangan lupa cek member..\n⌬ Kali aja ada yang jomblo 😂😂   ",
    "leave":"◊ Bye bye.... \n◊ Semoga tenang di alam sana 😂😂😂   ",
    "comment":"⌬ Done Like ✔️ ⌬",
    "message":"⌬ Nah loh ketahuan kan ADD gua 😂😂😂   ",
}
read = {
    "readPoint":{},
    "readMember":{},
...
def leaveMembers(to, mid):
    try:
        arrData = ""
        textx = "⌬ Tu kan lemper 🙄🙄   ".format(str(len(mid)))
        arr = []
        no = 1
        num = 2
        for i in mid:
...
def help2():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage2= "╔━━━═══[[ ✳️ 𝐒𝐄𝐓𝐓𝐈𝐍𝐆 ✳️ ]]═══━━━\n" + \
                  "╠💠❂͜͡➣ " + key + "ɪɴᴠɪᴛᴇ「ᴏɴ/ᴏғғ」\n" + \
                  "╠💠❂͜͡➣ " + key + "sᴛɪᴄᴋᴇʀ「ᴏɴ/ᴏғғ」\n" + \
                  "╠💠❂͜͡➣ " + key + "ᴜɴsᴇɴᴅ「ᴏɴ/ᴏғғ」\n" + \
                  "╠💠❂͜͡➣ " + key + "sɪᴅᴇʀ「ᴏɴ/ᴏғғ」\n" + \
                  "╠💠❂͜͡➣ " + key + "ʀᴇsᴘᴏɴ「ᴏɴ/ᴏғғ」\n" + \
                  "╠💠❂͜͡➣ " + key + "ᴛɪᴍᴇʟɪɴᴇ「ᴏɴ/ᴏғғ」\n" + \
                  "╠💠❂͜͡➣ " + key + "ᴄᴏɴᴛᴀᴄᴛ「ᴏɴ/ᴏғғ」\n" + \
                  "╠💠❂͜͡➣ " + key + "ᴀᴜᴛᴏᴊᴏɪɴ「ᴏɴ/ᴏғғ」\n" + \
                  "╠💠❂͜͡➣ " + key + "ᴀᴜᴛᴏᴀᴅᴅ「ᴏɴ/ᴏғғ」\n" + \
                  "╠💠❂͜͡➣ " + key + "ᴡᴇʟᴄᴏᴍᴇ「ᴏɴ/ᴏғғ」\n" + \
                  "╠💠❂͜͡➣ " + key + "ᴀᴜᴛᴏʟᴇᴀᴠᴇ「ᴏɴ/ᴏғғ」\n" + \
                  "╠💠❂͜͡➣ " + key + "ᴊᴏɪɴᴛɪᴄᴋᴇᴛ「ᴏɴ/ᴏғғ」\n" + \
                  "╠💠❂͜͡➣ " + key + "ᴄᴇᴋ sɪᴅᴇʀ\n" + \
                  "╠💠❂͜͡➣ " + key + "ᴄᴇᴋ sᴘᴀᴍ\n" + \
                  "╠💠❂͜͡➣ " + key + "ᴄᴇᴋ ᴘᴇsᴀɴ  \n" + \
                  "╠💠❂͜͡➣ " + key + "ᴄᴇᴋ ʀᴇsᴘᴏɴ \n" + \
                  "╠💠❂͜͡➣ " + key + "ᴄᴇᴋ ʟᴇᴀᴠᴇ\n" + \
                  "╠💠❂͜͡➣ " + key + "ᴄᴇᴋ ᴡᴇʟᴄᴏᴍᴇ\n" + \
                  "╠💠❂͜͡➣ " + key + "sᴇᴛ sɪᴅᴇʀ:「ᴛᴇxᴛ」\n" + \
                  "╠💠❂͜͡➣ " + key + "sᴇᴛ sᴘᴀᴍ:「ᴛᴇxᴛ」」\n" + \
                  "╠💠❂͜͡➣ " + key + "sᴇᴛ ᴘᴇsᴀɴ:「ᴛᴇxᴛ」\n" + \
                  "╠💠❂͜͡➣ " + key + "sᴇᴛ ʀᴇsᴘᴏɴ:「ᴛᴇxᴛ」\n" + \
                  "╠💠❂͜͡➣ " + key + "sᴇᴛ ʟᴇᴀᴠᴇ:「ᴛᴇxᴛ」\n" + \
                  "╠💠❂͜͡➣ " + key + "sᴇᴛ ᴡᴇʟᴄᴏᴍᴇ:「ᴛᴇxᴛ」\n" + \
                  "╠━━━━━[[ ✳️ 𝐄𝐗-𝐁𝐎𝐓𝐒 ✳️ ]]═══━━━\n" + \
                  "╚━━━━━ Creator:  line.me/ti/p/momoci27"
    ...
    try:
        ...
        if op.type == 13:
            if op.param2 in wait["blacklist"]:
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    try:
                        group = random.choiceABC.getGroup(op.param1)
                        gMembMids = [contact.mid for contact in group.invitee]
                        for _mid in gMembMids:
                            random.choiceABC.cancelGroupInvitation(op.param1,[op.param2])
              ...
              if op.param3 in Bots:    
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    ...
                    try:
                        if op.param3 not in wait["blacklist"]:
                            random.choice(ABC).kickoutFromGroup(op.param1,[op.param2])
                            random.choice(ABC).inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                    except:
                        pass
            ...
            if mid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        try:
                            kk.kickoutFromGroup(op.param1,[op.param2])
                            kk.inviteIntoGroup(op.param1,[op.mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                            cl.acceptGroupInvitation(op.param1)
                        except:
                            try:
                                kc.kickoutFromGroup(op.param1,[op.param2])
                                kc.inviteIntoGroup(op.param1,[op.mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                                cl.acceptGroupInvitation(op.param1)
                            except:
                                try:
                                    kb.kickoutFromGroup(op.param1,[op.param2])
                                    kb.inviteIntoGroup(op.param1,[op.mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                                    cl.acceptGroupInvitation(op.param1)
                                except:
                                    try:
                                        kd.kickoutFromGroup(op.param1,[op.param2])
                                        kd.inviteIntoGroup(op.param1,[op.mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                                        cl.acceptGroupInvitation(op.param1)     
                                    except:
                                        try:
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                ret_ += "\n♦𝐄𝐗-𝐁𝐎𝐓𝐒♦"
                                ret_ += "\n💠❂➣ Creator:  line.me/ti/p/~eric_xtrada27" 
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                md = "┝━━━━══━━═━━══━━━━\n│          ✳️ STATUS ✳️ \n"
                                if wait["stickerOn"] == True: md+=" [ ✳️ ] Sticker「ON」✔️\n"
                                else: md+=" [ ✳️ ] Sticker「OFF」❌\n"
                                if wait["contact"] == True: md+=" [ ✳️ ] Contact「ON」✔️\n"
                                else: md+=" [ ✳️ ] Contact「OFF」❌\n"
                                if wait["talkban"] == True: md+=" [ ✳️ ] Talkban「ON」✔️\n"
                                else: md+=" [ ✳️ ] Talkban「OFF」❌\n"
                                if wait["unsend"] == True: md+=" [ ✳️ ] Unsend「ON」✔️\n"
                                else: md+=" [ ✳️ ] Unsend「OFF」❌\n"
                                if settings["SpamInvite"] == True: md+=" [ ✳️ ] Spaminvite「ON」✔️\n"
                                else: md+=" [ ✳️ ] Spaminvite「OFF」❌\n"
                                if wait["detectMention"] == True: md+=" [ ✳️ ] Respon「ON」✔️\n"
                                else: md+=" [ ✳️ ] Respon「OFF」❌\n"
                                if wait["Timeline"] == True: md+=" [ ✳️ ] Timeline「ON」✔️\n"
                                else: md+=" [ ✳️ ] Timeline「OFF」❌\n"
                                if wait["autoJoin"] == True: md+=" [ ✳️ ] Autojoin「ON」✔️\n"
                                else: md+=" [ ✳️ ] Autojoin「OFF」❌\n"
                                if wait["autoAdd"] == True: md+=" [ ✳️ ] Autoadd「ON」✔️\n"
                                else: md+=" [ ✳️ ] Autoadd「OFF」❌\n"
                                if settings["autoJoinTicket"] == True: md+=" [ ✳️ ] Jointicket「ON」✔️\n"
                                else: md+=" [ ✳️ ] Jointicket「OFF」❌\n"
                                if msg.to in welcome: md+=" [ ✳️ ] Welcome「ON」✔️\n"
                                else: md+=" [ ✳️ ] Welcome「OFF」❌\n"
                                if wait["autoLeave"] == True: md+=" [ ✳️ ] Autoleave「ON」✔️\n"
                                else: md+=" [ ✳️ ] Autoleave「OFF」❌\n"
                                if msg.to in protectqr: md+=" [ ✳️ ] Protecturl「ON」✔️\n"
                                else: md+=" [ ✳️ ] Protecturl「OFF」❌\n"
                                if msg.to in protectjoin: md+=" [ ✳️ ] Protectjoin「ON」✔️\n"
                                else: md+=" [ ✳️ ] Protectjoin「OFF」❌\n"
                                if msg.to in protectjoin: md+=" [ ✳️ ] Protectinvite「ON」✔️\n"
                                else: md+=" [ ✳️ ] Protectinvite「OFF」❌\n"
                                if msg.to in protectkick: md+=" [ ✳️ ] Protectkick「ON」✔️\n"
                                else: md+=" [ ✳️ ] Protectkick「OFF」❌\n"
                                if msg.to in protectcancel: md+=" [ ✳️ ] Protectcancel「ON」✔️\n"
                                else: md+=" [ ✳️ ] Protectcancel「OFF」❌\n"
                                if msg.to in protectantijs: md+=" [ ✳️ ] Antijs「ON」✔️\n"
                                else: md+=" [ ✳️ ] Antijs「OFF」❌\n"  
                                if msg.to in ghost: md+=" [ ✳️ ] Ghost「ON」✔️\n"
                                else: md+=" [ ✳️ ] Ghost「OFF」❌\n"
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                ret_ += "\n┝═♦sᴘᴇᴇᴅ ʀᴇsᴘᴏɴ♦\n┝═✳️ {} ᴅᴇᴛɪᴋ".format(str(elapsed_time))
                                ret_ += "\n┝═♦sᴇʟғʙᴏᴛ ʀᴜɴᴛɪᴍᴇ♦\n┝═✳️ {}".format(str(bot))
                                ret_ += "\n╰━━━══[♦𝐄𝐗-𝐁𝐎𝐓𝐒♦]══━━━"
                                ry = str(ryan.displayName)
                                pesan = ''
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "✳️USER NAME✳️\n✳️User :", "")
                               msg.contentType = 13
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage(msg.to, None, contentMetadata={'Waalaikumsalam': key1}, contentType=13)
...
#=========KICKALL=========
                        elif ".tatar" in msg.text:
                          if msg._from in creator or msg._from in mid:
                             ex = cl.getGroup(msg.to)
                             eb = [contact.mid for contact in ex.invitee]
                             exb = [contact.mid for contact in ex.members]
                             for x in eb:
                                 try:
                                     cl.cancelGroupInvitation(msg.to,[x])
                                     ki.cancelGroupInvitation(msg.to,[x])
                                     kk.cancelGroupInvitation(msg.to,[x])
                                     ...
                                     kf.cancelGroupInvitation(msg.to,[x])
                                 except:
                                     pass
                             for xx in exb:
                                 try:
                                     cl.kickoutFromGroup(msg.to,[xx])
                                     ki.kickoutFromGroup(msg.to,[xx])
                                     kk.kickoutFromGroup(msg.to,[xx])
                                     kckickoutFromGroup(msg.to,[xx])
                                     kb.kickoutFromGroup(msg.to,[xx])
                                     kd.kickoutFromGroup(msg.to,[xx])
                                     ke.kickoutFromGroup(msg.to,[xx])
                                     kf.kickoutFromGroup(msg.to,[xx])
                                 except:
                                     pass
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                        ...
                        elif cmd == "ex" or cmd == "exbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[♦ 𝐄𝐗-𝐁𝐎𝐓𝐒 ♦].")
                               elapsed_time = time.time() - start
                               ki.sendMessage(msg.to, "[[♦𝐀𝐒𝐇𝐈𝐈𝐀𝐀𝐏𝐏 𝐁𝐎𝐒𝐒𝐐𝐔♦]]".format(str(elapsed_time)))
                               kk.sendMessage(msg.to, "[[♦𝐀𝐒𝐇𝐈𝐈𝐀𝐀𝐏𝐏 𝐁𝐎𝐒𝐒𝐐𝐔♦]]".format(str(elapsed_time)))
                               kc.sendMessage(msg.to, "[[♦𝐀𝐒𝐇𝐈𝐈𝐀𝐀𝐏𝐏 𝐁𝐎𝐒𝐒𝐐𝐔♦]]".format(str(elapsed_time)))
                               kb.sendMessage(msg.to, "[[♦𝐀𝐒𝐇𝐈𝐈𝐀𝐀𝐏𝐏 𝐁𝐎𝐒𝐒𝐐𝐔♦]]".format(str(elapsed_time)))
                               kd.sendMessage(msg.to, "[[♦𝐀𝐒𝐇𝐈𝐈𝐀𝐀𝐏𝐏 𝐁𝐎𝐒𝐒𝐐𝐔♦]]".format(str(elapsed_time)))
                               ke.sendMessage(msg.to, "[[♦𝐀𝐒𝐇𝐈𝐈𝐀𝐀𝐏𝐏 𝐁𝐎𝐒𝐒𝐐𝐔♦]]".format(str(elapsed_time)))
                               kf.sendMessage(msg.to, "[[♦𝐀𝐒𝐇𝐈𝐈𝐀𝐀𝐏𝐏 𝐁𝐎𝐒𝐒𝐐𝐔♦]]".format(str(elapsed_time)))
                               kj.sendMessage(msg.to, "[[♦𝐀𝐒𝐇𝐈𝐈𝐀𝐀𝐏𝐏 𝐁𝐎𝐒𝐒𝐐𝐔♦]]".format(str(elapsed_time)))
                               sw.sendMessage(msg.to, "[[♦𝐃𝐎𝐍𝐄 𝐁𝐎𝐒𝐒𝐐𝐔♦]]")
                               cl.sendMessage(msg.to, "[[♦𝐀𝐌𝐀𝐍 𝐁𝐎𝐒𝐒𝐐𝐔♦]]")
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                if has == "OK":sil = "sehat ✔️"
                                else:sil = "sakit ❌"
                                if has1 == "OK":sil1 = "sehat ✔️"
                                else:sil1 = "sakit ❌"
                                cl.sendMessage(to, "✳️ Kesehatan\n⏩ Kick : {} \n⏩ Invite : {}".format(sil1,sil))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[♦𝐄𝐗-𝐁𝐎𝐓𝐒♦]1")
                                ki.sendMessage(msg.to, "[♦𝐄𝐗-𝐁𝐎𝐓𝐒♦]2")
                                kk.sendMessage(msg.to, "[♦𝐄𝐗-𝐁𝐎𝐓𝐒♦]3")
                                kc.sendMessage(msg.to, "[♦𝐄𝐗-𝐁𝐎𝐓𝐒♦]4")
                                kb.sendMessage(msg.to, "[♦𝐄𝐗-𝐁𝐎𝐓𝐒♦]5")
                                kd.sendMessage(msg.to, "[♦𝐄𝐗-𝐁𝐎𝐓𝐒♦]6")
                                ke.sendMessage(msg.to, "[♦𝐄𝐗-𝐁𝐎𝐓𝐒♦]7")
                                kf.sendMessage(msg.to, "[♦𝐄𝐗-𝐁𝐎𝐓𝐒♦]8")
                                kj.sendMessage(msg.to, "[♦𝐄𝐗-𝐁𝐎𝐓𝐒♦]9")
                                sw.sendMessage(msg.to, "[♦𝐄𝐗-𝐁𝐎𝐓𝐒♦]10")
                                cl.sendMessage(msg.to, "[[♦𝐃𝐎𝐍𝐄 𝐁𝐎𝐒𝐒𝐐𝐔♦]]")
...
#===========BOT UPDATE============#
                        elif cmd == "mention" or text.lower() == 'all' or text.lower() == 'tag':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               group = cl.getGroup(msg.to)
                               nama = [contact.mid for contact in group.members]
                               nm1, nm2, nm3, nm4,nm5,nm6,nm7,nm8,nm9,nm10,nm11,nm12,nm13,nm14,nm15,nm16,nm17,nm18,nm19,nm20,nm21,nm22,nm23,nm24,nm25,nm26 , jml = [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [] ,[] , len(nama)
                               if jml <= 20:
                               ...
                               if jml > 440 and jml < 460:
                                   ...
                                   for c in range (400, 420):
                                       nm21 += [nama[c]]
                                   mentionMembers(msg.to, nm21)
                                   for d in range (420, 440):
                                       nm22 += [nama[d]]
                                   mentionMembers(msg.to, nm22)
                                   for e in range (440, len(nama)-1):
                                       nm23 += [nama[e]]
                               ...
                               if jml > 460 and jml < 480:
                                   ...
                                   for d in range (420, 440):
                                       nm22 += [nama[d]]
                                   mentionMembers(msg.to, nm22)
                                   for e in range (440, 460):
                                       nm23 += [nama[e]]
                                   mentionMembers(msg.to, nm23)
                                   for f in range (460, len(nama)-1):
                                       nm24 += [nama[f]]
                               ...
                               if jml > 500 and jml < 520:
                                   ...
                                   for f in range (460, 480):
                                       nm24 += [nama[f]]
                                   mentionMembers(msg.to, nm24)
                                   for g in range (480, 500):
                                       nm25 += [nama[g]]
                                   mentionMembers(msg.to, nm25)
                                   for h in range (500, len(nama)-1):
                                       nm26 += [nama[h]]
                                   mentionMembers(msg.to, nm26)

#===========BOT UPDATE============#
                        elif msg.text in ["Members","Tagall","Dor"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
                                 group = cl.getGroup(msg.to)
                                nama = [contact.mid for contact in group.members]
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"[ ✳️ ᴘʀᴏᴛᴇᴄᴛ ʟɪsᴛ ✳️ ]\n\n🔐ᴘʀᴏᴛᴇᴄᴛ ǫʀ:\n"+ma+"\n🔒ᴘʀᴏᴛᴇᴄᴛ ɪɴᴠɪᴛᴇ:\n"+mb+"\n🔒ᴘʀᴏᴛᴇᴄᴛᴀɴᴛɪᴋɪᴄᴋᴇʀ:\n"+mc+"\n🔒ᴘʀᴏᴛᴇᴄᴛᴋɪᴄᴋ:\n"+md+"\n🔒ᴘʀᴏᴛᴇᴄᴛᴄᴀɴᴄᴇʟ:\n"+me+"\n🔒ᴘʀᴏᴛᴇᴄᴛᴊᴏɪɴ:\n"+mf+"\n🔒ɢʜᴏsᴛ:\n"+mg+"\n\n[ ✳️ ᴘʀᴏᴛᴇᴄᴛ ʟɪsᴛ %s ɢʀᴏᴜᴘ ᴘʀᴏᴛᴇᴄᴛ ✳️ ]" %(str(len(protectqr)+len(protectinvite)+len(protectantijs)+len(protectcancel)+len(protectkick)+len(protectjoin)+len(ghost))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               sendMention(msg.to, sender, " Speed Up\n User : ", "")
                               elapsed_time = time.time() - start
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  cl.sendMessage(msg.to, "⏩ Cek sider [ ✔️ ] \n🗓 Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\n⌚️ Jam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  cl.sendMessage(msg.to, "⏩ Cek sider [ ❌ ] \n🗓 Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+" \n⌚️ Jam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                              else:
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    cl.sendMessage(msg.to,"Grup "+str(ginfo.name)+"Ready")
                                except:
                                    pass           
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                G.preventedJoinByTicket = True
                                cl.updateGroup(G)
                                cl.inviteIntoGroup(msg.to, [Zmid,Jmid])

                        elif cmd == ".out":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                ki.cancelGroupInvitation(msg.to, [Zmid])
                                kk.cancelGroupInvitation(msg.to, [Jmid])
                                ki.leaveGroup(msg.to)
                                kk.leaveGroup(msg.to)
                                kc.leaveGroup(msg.to)
                                kb.leaveGroup(msg.to)
                          ...
                          if wait["selfbot"] == True:
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectantijs:
                                       msgs = "Anti JS sudah aktif ✔️"                                  
                                  else:
                                       protectantijs.append(msg.to)
                                       ginfo = cl.getGroup(msg.to)
                                       msgs = "Anti JS Diaktifkan\nDi Group : " +str(ginfo.name)
                                  cl.sendMessage(msg.to, "Status: [ ✔️ ]\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectantijs:
                           ...
                           if msg._from in admin:
                              spl = msg.text.replace('Gh ','')
                              if spl == 'on':
                                  if msg.to in ghost:
                                       msgs = "Ghost sudah aktif ✔️"
                                  else:
                                       ghost.append(msg.to)
                                       ginfo = cl.getGroup(msg.to)
...
#===========Protection============#
                        ...
                        elif 'Expro ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Expro ','')
                              if spl == 'on':
                                  if msg.to in protectqr:
                                       msgs = ""
                                  else:
